        ...
        if command in ("q", "quit", "exit"):
            ...
            if available_rooms:
                ...
                for room in available_rooms:
                    print(f"- Room {room['number']} ({room['price_per_night']} gold per night)")
            else:
            ...
            if success:
                ...
                if clock.time.hours >= 48 and not player.has_room and not player.no_sleep_quest_unlocked:
                    print("\nYou've been awake for 48 hours without sleeping...")
                    print("Something strange is happening. The air feels charged with energy.")
