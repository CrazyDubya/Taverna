...
def run_sample_complex_test():
    ...
    sample_commands = [
        ...
        # Multi-part commands
        ("I want to buy some ale and then talk to the bartender", "multipart", "complex"),
        ("Show me the jobs available and also check what time it is", "multipart", "complex"),
        ("Check the notice board and if there's anything interesting, accept it", "multipart", "complex"),
        ("Talk to whoever's here and ask them about work opportunities", "multipart", "complex"),
        ("I need to rest but first make sure I have enough money", "multipart", "complex"),
        
        # Emotional/roleplay
        ("I'm feeling overwhelmed by all these choices", "emotional", "complex"),
        ("This place makes me nervous, I don't know what to do", "emotional", "complex"),
    ...
    for cat, stats in sorted(categories.items()):
        ...
        if stats['failures']:
            ...
            for failure in stats['failures'][:3]:
                print(f"        • '{failure['command'][:40]}...' → {failure['error_type']}")
