...
class TavernCalendar:
    ...
    SEASON_MAP = {
        0: Season.WINTER, 1: Season.WINTER, 2: Season.SPRING,
        3: Season.SPRING, 4: Season.SPRING, 5: Season.SUMMER,
        6: Season.SUMMER, 7: Season.SUMMER, 8: Season.AUTUMN,
        9: Season.AUTUMN, 10: Season.AUTUMN, 11: Season.WINTER
    }
