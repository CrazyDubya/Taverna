...
class NPCSchedule:
    ...
    def _create_bartender_schedule(self) -> None:
        ...
        normal_schedule = [
            ScheduleBlock(
                time(6, 0), time(7, 0), ActivityType.PERSONAL,
                "quarters", "Morning routine", priority=8, flexible=True
            ),
            ScheduleBlock(
                time(7, 0), time(8, 0), ActivityType.EAT,
                "kitchen", "Breakfast", priority=7, interruptible=True
            ),
            ScheduleBlock(
                time(8, 0), time(12, 0), ActivityType.WORK,
                "bar_area", "Morning shift - preparing and serving", priority=9,
                interruptible=True, energy_cost=0.2
            ),
            ScheduleBlock(
                time(12, 0), time(13, 0), ActivityType.EAT,
                "kitchen", "Lunch break", priority=7
            ),
            ScheduleBlock(
                time(13, 0), time(18, 0), ActivityType.WORK,
                "bar_area", "Afternoon shift - busy period", priority=10,
                interruptible=False, energy_cost=0.3
            ),
            ScheduleBlock(
                time(18, 0), time(19, 0), ActivityType.EAT,
                "kitchen", "Dinner break", priority=7
            ),
            ScheduleBlock(
                time(19, 0), time(23, 0), ActivityType.WORK,
                "bar_area", "Evening shift - peak hours", priority=10,
                interruptible=False, energy_cost=0.4
            ),
            ScheduleBlock(
                time(23, 0), time(23, 30), ActivityType.WORK,
                "bar_area", "Closing duties", priority=8
            ),
            ScheduleBlock(
                time(23, 30), time(6, 0), ActivityType.SLEEP,
                "quarters", "Sleep", priority=10, interruptible=False
            )
        ]
        ...
        # Add variations
        self.variations.append(ScheduleVariation(
            condition=Condition(
                ConditionType.STATE,
                {"key": "tavern_crowded", "value": True}
            ),
            replacement_blocks=[
                ScheduleBlock(
                    time(12, 0), time(12, 30), ActivityType.EAT,
                    "bar_area", "Quick lunch behind bar", priority=6,
                    flexible=True
                )
            ],
    ...
    def _create_guard_schedule(self) -> None:
        ...
        normal_schedule = [
            ScheduleBlock(
                time(6, 0), time(7, 0), ActivityType.PERSONAL,
                "quarters", "Morning routine and equipment check", priority=8
            ),
            ScheduleBlock(
                time(7, 0), time(7, 30), ActivityType.EAT,
                "kitchen", "Breakfast", priority=7
            ),
            ScheduleBlock(
                time(7, 30), time(12, 0), ActivityType.PATROL,
                "main_hall", "Morning patrol", priority=9,
                energy_cost=0.2
            ),
            ScheduleBlock(
                time(12, 0), time(13, 0), ActivityType.EAT,
                "main_hall", "Lunch while watching", priority=7
            ),
            ScheduleBlock(
                time(13, 0), time(18, 0), ActivityType.PATROL,
                "various", "Afternoon rounds", priority=9,
                energy_cost=0.25
            ),
            ScheduleBlock(
                time(18, 0), time(19, 0), ActivityType.EAT,
                "kitchen", "Dinner", priority=7
            ),
            ScheduleBlock(
                time(19, 0), time(2, 0), ActivityType.PATROL,
                "main_hall", "Night watch - peak hours", priority=10,
                interruptible=False, energy_cost=0.3
            ),
            ScheduleBlock(
                time(2, 0), time(6, 0), ActivityType.SLEEP,
                "quarters", "Sleep", priority=10
            )
        ]
        ...
        self.variations.append(ScheduleVariation(
            condition=Condition(
                ConditionType.TIME,
                {"start_hour": 13, "end_hour": 18}
            ),
            replacement_blocks=[
                ScheduleBlock(
                    time(13, 0), time(14, 0), ActivityType.PATROL,
                    "gambling_den", "Check gambling den", priority=9
                ),
                ScheduleBlock(
                    time(14, 0), time(15, 0), ActivityType.PATROL,
                    "wine_cellar", "Check cellars", priority=9
                ),
                ScheduleBlock(
                    time(15, 0), time(16, 0), ActivityType.PATROL,
                    "guest_hallway", "Check guest floors", priority=9
                ),
                ScheduleBlock(
                    time(16, 0), time(18, 0), ActivityType.PATROL,
                    "main_hall", "Return to main hall", priority=9
                )
            ],
    ...
    def _create_merchant_schedule(self) -> None:
        ...
        normal_schedule = [
            ScheduleBlock(
                time(7, 0), time(8, 0), ActivityType.PERSONAL,
                "guest_room_2", "Morning routine", priority=7
            ),
            ScheduleBlock(
                time(8, 0), time(9, 0), ActivityType.EAT,
                "main_hall", "Breakfast in common room", priority=7
            ),
            ScheduleBlock(
                time(9, 0), time(12, 0), ActivityType.WORK,
                "main_hall", "Meeting with potential customers", priority=8,
                energy_cost=0.15
            ),
            ScheduleBlock(
                time(12, 0), time(13, 0), ActivityType.EAT,
                "main_hall", "Lunch", priority=7
            ),
            ScheduleBlock(
                time(13, 0), time(17, 0), ActivityType.WORK,
                "private_booth", "Private business dealings", priority=9,
                energy_cost=0.2
            ),
            ScheduleBlock(
                time(17, 0), time(19, 0), ActivityType.SOCIAL,
                "fireplace_nook", "Socializing and networking", priority=6
            ),
            ScheduleBlock(
                time(19, 0), time(20, 0), ActivityType.EAT,
                "main_hall", "Dinner", priority=7
            ),
            ScheduleBlock(
                time(20, 0), time(22, 0), ActivityType.LEISURE,
                "gambling_den", "Gambling and entertainment", priority=5,
                flexible=True
            ),
            ScheduleBlock(
                time(22, 0), time(7, 0), ActivityType.SLEEP,
                "guest_room_2", "Sleep", priority=10
            )
        ]
        ...
        market_schedule[2] = ScheduleBlock(
            time(9, 0), time(12, 0), ActivityType.WORK,
            "courtyard", "Visiting market stalls", priority=9,
            energy_cost=0.25
        )
    ...
    def _create_patron_schedule(self) -> None:
        ...
        normal_schedule = [
            ScheduleBlock(
                time(8, 0), time(9, 0), ActivityType.PERSONAL,
                "guest_room_1", "Morning routine", priority=6, flexible=True
            ),
            ScheduleBlock(
                time(9, 0), time(10, 0), ActivityType.EAT,
                "main_hall", "Late breakfast", priority=6, flexible=True
            ),
            ScheduleBlock(
                time(10, 0), time(12, 0), ActivityType.LEISURE,
                "main_hall", "Drinking and chatting", priority=4,
                energy_cost=0.05
            ),
            ScheduleBlock(
                time(12, 0), time(13, 0), ActivityType.EAT,
            ...
            ScheduleBlock(
                time(13, 0), time(15, 0), ActivityType.LEISURE,
                "fireplace_nook", "Afternoon relaxation", priority=3
            ),
            ScheduleBlock(
                time(15, 0), time(18, 0), ActivityType.SOCIAL,
                "main_hall", "Socializing with other patrons", priority=5
            ),
            ScheduleBlock(
                time(18, 0), time(19, 0), ActivityType.EAT,
                "main_hall", "Dinner", priority=7
            ...
            ScheduleBlock(
                time(19, 0), time(22, 0), ActivityType.LEISURE,
                "main_hall", "Evening drinking", priority=5,
                energy_cost=0.1
            ),
            ScheduleBlock(
                time(22, 0), time(23, 0), ActivityType.LEISURE,
                "gambling_den", "Late night gambling", priority=4,
                flexible=True
            ),
            ScheduleBlock(
                time(23, 0), time(8, 0), ActivityType.SLEEP,
                "guest_room_1", "Sleep", priority=9
            )
        ]
        ...
        self.variations.append(ScheduleVariation(
            condition=Condition(
                ...
                {"character_type": "drinking_buddy"}
            ),
            replacement_blocks=[
                ScheduleBlock(
                    time(19, 0), time(1, 0), ActivityType.SOCIAL,
                    "main_hall", "Drinking with friends", priority=7,
                    energy_cost=0.2
                )
            ],
    ...
    def _create_cook_schedule(self) -> None:
        ...
        normal_schedule = [
            ScheduleBlock(
                time(4, 0), time(5, 0), ActivityType.PERSONAL,
                "quarters", "Early morning routine", priority=8
            ),
            ScheduleBlock(
                time(5, 0), time(7, 0), ActivityType.WORK,
                "kitchen", "Breakfast preparation", priority=10,
                energy_cost=0.2
            ),
            ScheduleBlock(
                time(7, 0), time(8, 0), ActivityType.EAT,
                "kitchen", "Quick breakfast", priority=7
            ),
            ScheduleBlock(
                time(8, 0), time(12, 0), ActivityType.WORK,
                "kitchen", "Lunch preparation and cooking", priority=10,
                energy_cost=0.3
            ),
            ScheduleBlock(
                time(12, 0), time(13, 0), ActivityType.EAT,
                "kitchen", "Lunch break", priority=8
            ),
            ScheduleBlock(
                time(13, 0), time(14, 0), ActivityType.PERSONAL,
                "courtyard", "Rest and fresh air", priority=5,
                flexible=True
            ),
            ScheduleBlock(
                time(14, 0), time(19, 0), ActivityType.WORK,
                "kitchen", "Dinner preparation - busiest time", priority=10,
                interruptible=False, energy_cost=0.4
            ),
            ScheduleBlock(
                time(19, 0), time(20, 0), ActivityType.EAT,
                "kitchen", "Dinner", priority=8
            ),
            ScheduleBlock(
                time(20, 0), time(21, 0), ActivityType.WORK,
                "kitchen", "Kitchen cleanup", priority=8
            ),
            ScheduleBlock(
                time(21, 0), time(4, 0), ActivityType.SLEEP,
                "quarters", "Sleep", priority=10
            )
        ]
    ...
    def _create_generic_schedule(self) -> None:
        ...
        normal_schedule = [
            ScheduleBlock(
                time(7, 0), time(8, 0), ActivityType.PERSONAL,
                "quarters", "Morning routine", priority=7
            ),
            ScheduleBlock(
                time(8, 0), time(9, 0), ActivityType.EAT,
                "main_hall", "Breakfast", priority=7
            ),
            ScheduleBlock(
                time(9, 0), time(12, 0), ActivityType.WORK,
                "main_hall", "Work or activities", priority=8
            ),
            ScheduleBlock(
                time(12, 0), time(13, 0), ActivityType.EAT,
                "main_hall", "Lunch", priority=7
            ...
            ScheduleBlock(
                time(13, 0), time(18, 0), ActivityType.WORK,
                "main_hall", "Afternoon activities", priority=8
            ),
            ScheduleBlock(
                time(18, 0), time(19, 0), ActivityType.EAT,
                "main_hall", "Dinner", priority=7
            ...
            ScheduleBlock(
                time(19, 0), time(22, 0), ActivityType.LEISURE,
                "main_hall", "Evening relaxation", priority=5
            ),
            ScheduleBlock(
                time(22, 0), time(7, 0), ActivityType.SLEEP,
                "quarters", "Sleep", priority=10
    ...
    def get_current_block(self, current_time: datetime, 
                         day_type: DayType = DayType.NORMAL,
                         context: Optional[Dict[str, Any]] = None) -> Optional[ScheduleBlock]:
    ...
    def get_next_block(self, current_time: datetime,
                      day_type: DayType = DayType.NORMAL) -> Optional[ScheduleBlock]:
    ...
    def should_transition(self, current_time: datetime,
                         day_type: DayType = DayType.NORMAL,
                         context: Optional[Dict[str, Any]] = None) -> Tuple[bool, Optional[ScheduleBlock]]:
