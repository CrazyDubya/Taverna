...
class CharacterMemory:
    ...
    def add_memory(self, interaction_type: str, player_action: str, 
                   npc_response: str, emotional_impact: float, 
    ...
    def _update_relationship(self, impact: float) -> None:
        ...
        self.relationship_score = max(-1.0, min(1.0, 
            self.relationship_score * 0.9 + impact * weight * 0.1
        ))
    ...
    def cleanup_old_memories(self, max_age_days: int = 30) -> None:
        ...
        for memory in self.character_memories.values():
            ...
            memory.memories = [
                ...
                if m.age_in_hours(current_time) < max_age_hours or m.referenced_count > 5
            ]
