...
class DynamicQuest:
    ...
    def __init__(self, quest_id: str, title: str, quest_type: QuestType, 
                 description: str, giver_npc_id: str):
...
class QuestTemplate:
    ...
    def __init__(self, template_id: str, quest_type: QuestType, 
                 title_templates: List[str], description_templates: List[str]):
    ...
    def generate_quest(self, context: Dict[str, Any]) -> Optional[DynamicQuest]:
        ...
        if quest.urgency in [QuestUrgency.URGENT, QuestUrgency.CRITICAL]:
            urgency_hours = {
                QuestUrgency.URGENT: 48.0,
                QuestUrgency.CRITICAL: 24.0
            }
...
class DynamicQuestGenerator:
    ...
    def _initialize_default_templates(self):
        ...
        fetch_template.reward_templates = [
            QuestReward(gold=25, reputation_boost=0.1)
        ]
    ...
    def _should_generate_new_quest(self, game_state: Any) -> bool:
        ...
        recent_completions = len([
            q for q in self.completed_quests.values()
    ...
    def _give_quest_rewards(self, quest: DynamicQuest, game_state: Any) -> None:
        ...
        if rewards.reputation_boost > 0 and hasattr(game_state, 'reputation_network'):
            game_state.reputation_network.record_player_action(
                "quest_completion", "completed", [quest.giver_npc_id],
