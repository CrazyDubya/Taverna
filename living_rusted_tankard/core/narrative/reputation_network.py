...
class NPCReputation:
    ...
    def get_gossip_to_share(self) -> Optional[Tuple[ReputationAspect, float, str]]:
        ...
        confident_opinions = [
            (aspect, opinion) for aspect, opinion in self.opinions.items()
...
class ReputationNetwork:
    ...
    def add_social_connection(self, npc1_id: str, npc2_id: str, 
    ...
    def record_player_action(self, action_type: str, outcome: str, 
                           witnesses: List[str], context: Dict[str, Any]):
    ...
    def _queue_gossip_spread(self, action_type: str, outcome: str, 
                           initial_witnesses: List[str], context: Dict[str, Any]):
...
def setup_reputation_network_for_profession(reputation_network: ReputationNetwork, 
