...
class PersonalityProfile:
    ...
    def add_trait(self, trait: PersonalityTrait, intensity: float, 
                  triggers: List[str], dialogue_mods: Dict[str, str],
                  behavior_mods: Dict[str, float]) -> None:
    ...
    def get_personality_summary(self) -> str:
        ...
        dominant_traits = sorted(self.traits.values(), 
                               key=lambda t: t.intensity, reverse=True)[:3]
        
        trait_descriptions = []
        for trait_expr in dominant_traits:
            intensity_desc = "very" if trait_expr.intensity > 0.7 else "somewhat" if trait_expr.intensity > 0.4 else "mildly"
...
def create_personality_from_profession(npc_id: str, npc_name: str, profession: str) -> PersonalityProfile:
    ...
    if profession.lower() in ["bartender", "innkeeper"]:
        ...
        profile.add_trait(
            PersonalityTrait.EXTROVERTED, 0.7,
        ...
        profile.add_trait(
            PersonalityTrait.AMBITIOUS, 0.8,
        ...
        profile.add_trait(
            PersonalityTrait.PERFECTIONIST, 0.8,
        ...
        profile.add_trait(
            PersonalityTrait.HARDWORKING, 0.7,
        ...
        profile.add_trait(
            PersonalityTrait.CONFIDENT, 0.6,
        ...
        for trait, intensity, triggers in random_traits:
            profile.add_trait(
                trait, intensity + random.uniform(-0.2, 0.2),
                triggers=triggers,
    ...
    secondary_traits = [
        ...
        PersonalityTrait.PATIENT, PersonalityTrait.HOT_TEMPERED,
        PersonalityTrait.CURIOUS, PersonalityTrait.SECRETIVE
    ]
...
class PersonalityManager:
    ...
    def get_or_create_personality(self, npc_id: str, npc_name: str, 
                                profession: Optional[str] = None) -> PersonalityProfile:
    ...
    def modify_dialogue_for_personality(self, npc_id: str, base_message: str, 
                                     situation: str = "conversation") -> str:
