...
class NarrativePersistenceManager:
    ...
    def save_all_narrative_state(self, session_id: str, 
                                save_format: SerializationFormat = None) -> bool:
    ...
    def load_narrative_state(self, session_id: str, 
                           specific_timestamp: Optional[int] = None) -> bool:
    ...
    def _serialize_component(self, component: Any, component_name: str) -> Dict[str, Any]:
        ...
        if component_name == 'character_memory_manager':
            ...
            for connection_key, connection in component.social_connections.items():
                component_data['social_connections'][str(connection_key)] = self._serialize_social_connection(connection)
            ...
            component_data['current_arc'] = self._serialize_narrative_arc(component.current_arc) if component.current_arc else None
    ...
    def _deserialize_component(self, component: Any, component_data: Dict[str, Any], 
                             component_name: str):
    ...
    def _write_narrative_file(self, data: Dict[str, Any], filepath: Path, 
                            save_format: SerializationFormat) -> bool:
    ...
    def _read_narrative_file(self, filepath: Path, 
                           save_format: SerializationFormat) -> Optional[Dict[str, Any]]:
