...
class NewsManager(BaseModel):
    ...
    def get_relevant_news(self, npc_type_str: str, current_day: int, active_events: Optional[List[str]] = None) -> List[NewsItem]:
        """
    ...
    def get_random_news_snippet(self, npc_type_str: str, current_day: int, active_events: Optional[List[str]] = None, recently_shared_ids: Optional[List[str]] = None) -> Optional[NewsItem]:
        """
