...
def check_enhanced_secrets():
    ...
    checks = [
        ("core/npc/secrets.py", "Enhanced Secrets"),
    ]
    ...
    if success:
        ...
        success = check_module_imports("core/npc/secrets.py", required)
...
def check_dialogue_system():
    ...
    checks = [
        ("core/npc/dialogue.py", "Dialogue System"),
    ]
    ...
    if success:
        ...
        success = check_module_imports("core/npc/dialogue.py", required)
...
def check_gossip_system():
    ...
    checks = [
        ("core/npc/gossip.py", "Gossip System"),
    ]
    ...
    if success:
        ...
        success = check_module_imports("core/npc/gossip.py", required)
...
def check_goals_agency():
    ...
    checks = [
        ("core/npc/goals.py", "Goals System"),
    ]
    ...
    if success:
        ...
        success = check_module_imports("core/npc/goals.py", required)
...
def check_interactions():
    ...
    checks = [
        ("core/npc/interactions.py", "Interactions System"),
    ]
    ...
    if success:
        ...
        success = check_module_imports("core/npc/interactions.py", required)
...
def check_phase2_compatibility():
    ...
    phase2_files = [
        ("core/npc/psychology.py", "Psychology (Phase 2)"),
        ("core/npc/behavioral_rules.py", "Behavioral Rules (Phase 2)"),
        ("core/npc/schedules.py", "Schedules (Phase 2)"),
        ("core/npc/relationships.py", "Relationships (Phase 2)"),
    ]
...
def check_code_quality():
    ...
    doc_count = 0
    for root, dirs, files in os.walk("core/npc"):
        for file in files:
