...
def check_phase_integration():
    ...
    print(f"Integration module: {integration_exists}/{len(integration_files)} files exist")
    ...
    print(f"Phase 1 (Quality):     ✅ Partially integrated (AIPlayerManager in use)")
    print(f"Phase 2 (World):       {'✅' if phase2_integrated else '❌'} {'Integrated' if phase2_integrated else 'NOT integrated'}")
    print(f"Phase 3 (NPCs):        {'✅' if phase3_integrated else '❌'} {'Integrated' if phase3_integrated else 'NOT integrated'}")
    print(f"Phase 4 (Narrative):   {'✅' if phase4_integrated else '❌'} {'Integrated' if phase4_integrated else 'NOT integrated'}")
    print(f"Integration Module:    {'✅' if any_integration else '❌'} {'Active' if any_integration else 'NOT active'}")
    ...
    print(f"Room System: {'Basic RoomManager' if 'RoomManager()' in game_state_content else 'Unknown'}")
    print(f"NPC System: {'Basic NPCManager' if 'NPCManager(' in game_state_content else 'Unknown'}")
    ...
    if not uses_integration:
        ...
        print("```python") 
        print("return self.phase_integration.enhance_npc_interaction(npc_name, base_response)")
        print("```")
