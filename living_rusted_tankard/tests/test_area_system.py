...
from core.world.atmosphere import AtmosphereState, AtmosphereManager, LightLevel, NoiseLevel, SensoryDetail
...
class TestAreaManager:
    ...
    def test_movement(self):
        ...
        result = manager.move_to_area("player1", "bar_area", access_level=AccessLevel.STAFF)
    ...
    def test_access_restrictions(self):
        ...
        result = manager.move_to_area("player1", "bar_area", access_level=AccessLevel.PUBLIC)
        assert not result.success
...
class TestIntegration:
    ...
    def test_complete_tavern_navigation(self):
        ...
        result = manager.move_to_area("player1", "kitchen", access_level=AccessLevel.STAFF)
        assert result.success
        ...
        # Down to cellar
        result = manager.move_to_area("player1", "wine_cellar", access_level=AccessLevel.PATRON)
        assert result.success
