...
class TestSecretGenerator:
    ...
    def test_generate_merchant_secret(self):
        ...
        assert secret.type in [SecretType.FINANCIAL, SecretType.CRIMINAL, 
    ...
    def test_evidence_generation(self):
        ...
        secret = SecretGenerator.generate_secret(
            npc_data,
            secret_type=SecretType.CRIMINAL
        )
    ...
    def test_consequence_generation(self):
        ...
        legal_consequences = [
            c for c in criminal_secret.consequences
        ...
        relationship_consequences = [
            c for c in romantic_secret.consequences
            if len(c.affects_relationships) > 0
        ]
